...
export function useGetForwarderProviderListById(id: string) {
  return useQuery({
    queryKey: ["document", id],
    queryFn: async () => {
      try {
...
export function useCreateForwarder(router: ReturnType<typeof useRouter>) {
  const queryClient = useQueryClient();
  return useMutation({
...
export function useGetEximDocumentById(id: string) {
  return useQuery({
    queryKey: ["document", id],
    queryFn: async () => {
      try {
...
export function useCreateEximDocument(router: ReturnType<typeof useRouter>) {
  const queryClient = useQueryClient();
  return useMutation({
