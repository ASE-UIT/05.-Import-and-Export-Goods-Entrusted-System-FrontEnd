...
export default function Page() {
  return (
    ...
    <div className="justify-start items-start gap-2.5 inline-flex">
        <div className="text-black text-3xl font-bold font-['Inter']">Contract List</div>
    </div>
     {/* Search - Button */}
     <div className="flex flex-row justify-between py-[28px] pl-0 pr-0 w-[1115px]">
        <div className="justify-start items-center inline-flex">
          ...
          <div className="flex items-center justify-start ml-0">
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem>Quote ID</DropdownMenuItem>
                <DropdownMenuItem>Employee ID</DropdownMenuItem>
                <DropdownMenuItem>Start Date</DropdownMenuItem>
                <DropdownMenuItem>Contract Date</DropdownMenuItem>
                <DropdownMenuItem>End Date</DropdownMenuItem>
                <DropdownMenuItem>Status</DropdownMenuItem>
                <DropdownMenuItem>Create At</DropdownMenuItem>
                <DropdownMenuItem>Update At</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </div>
        ...
        <Button className="p-2.5 bg-[#108080] rounded-[5px] justify-start items-center gap-2 flex">
          <Link href="/contract/addcontract"> {/*the link*/}
      ...
      <Table className="min-w-full">
            ...
            <TableBody>
                ...
                <TableCell>15-02-2024 15:22:24</TableCell>
                <TableCell>15-02-2024 15:22:24</TableCell>
                <TableCell>
                <Link href={"/contract/updatecontract"}>                    
