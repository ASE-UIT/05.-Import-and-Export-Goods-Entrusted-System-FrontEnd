        ...
        <div className="self-stretch h-full py-8 flex-col justify-start items-center gap-5 flex">
          <div className="flex-col justify-start items-start gap-5 flex">
            ...
            <div className="self-stretch h-[90px] flex flex-col justify-center">
              <div className="text-black text-base font-bold leading-normal tracking-wide">Quotation ID:</div>
              <Select>
            ...
            {/* Employee ID */}
            <div className="self-stretch h-[90px] flex flex-col justify-center">
              <div className="text-black text-base font-bold leading-normal tracking-wide">Employee ID:</div>
              <Select>
                <SelectTrigger className="h-[60px] w-[500px]">
